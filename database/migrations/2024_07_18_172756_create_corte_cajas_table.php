...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('corte_cajas', function (Blueprint $table) {
            ...
            $table->decimal('total_tarjetas_debito_registrado', total: 8 , places:2);//Cambios
            ...
            $table->decimal('total_documentos_registrado', total: 8 , places:2);//cambios
            ...
            $table->string('descripcion')->nullable();//cambios agregado
