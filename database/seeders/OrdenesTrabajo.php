...
class OrdenesTrabajo extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $conceptos = [
            ...
            "cambio de medidor" => "Sustitución del dispositivo que mide el consumo de agua en una propiedad. Este proceso puede realizarse por razones de mantenimiento, actualización del equipo o por mal funcionamiento del medidor existente.",
