                ...
                if ($Accion['campo']=="contrato_agua" || $Accion['campo']=="contrato_alcantarillado" || $Accion['campo']=="contrato_saneamiento" ){
                    ...
                    if ($estado=="activa"){
                        $valor=match($servicio){
                            'c_agua'=>Contrato::where('id_toma',$OTModelo['id'])->where('servicio_contratado','agua')->where('estatus','contratado')->first()->id ?? null,
                            'c_alc'=>Contrato::where('id_toma',$OTModelo['id'])->where('servicio_contratado','alcantarillado y saneamiento')->where('estatus','contratado')->first()->id ?? null,
                            'c_san'=>Contrato::where('id_toma',$OTModelo['id'])->where('servicio_contratado','alcantarillado y saneamiento')->where('estatus','contratado')->first()->id ?? null,
                        };
                        $dato=[$servicio=>$valor];
